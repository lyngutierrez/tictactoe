    ...
    /*public TicTacToe() {
        ...
        playButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                String[] options = {"X", "O"};
                int choice = JOptionPane.showOptionDialog(TicTacToe.this, "Choose your symbol:", "Player Selection", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
